                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-900 dark:text-gray-100">{rec.job.company.name}</p>
                        </div>
                    </div>

                    <p className="mt-2 text-gray-900 dark:text-gray-100">{rec.job.description}</p>

                    <div className="mt-2 flex flex-wrap gap-2 text-sm text-gray-600">
                        <span className='text-gray-900 dark:text-gray-100'>Salary: ₹{rec.job.salary}</span>
                        <span className='text-gray-900 dark:text-gray-100'>Experience: {rec.job.experienceLevel} yrs</span>
                        <span className='text-gray-900 dark:text-gray-100'>Location: {rec.job.location}</span>
                        <span className='text-gray-900 dark:text-gray-100'>Type: {rec.job.jobType}</span>
                    </div>
